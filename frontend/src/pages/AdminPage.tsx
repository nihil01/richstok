...
> = {
  az: {
    ...
    searchPlaceholder: "Ad / slug / sku üzrə axtarış",
    pagination: {
      prev: "Əvvəlki",
      next: "Növbəti",
      page: "Səhifə",
    ...
    importSubtitle: "Yalnız .xlsx və .xls. Mövcud SKU olarsa məhsul yenilənəcək.",
    importColumns: "Sütunlar: MƏHSULUN ADI, BREND KODU, OEM KODU, BAKİ/GANCA, QİYMƏT AZN (BAKİ/GANCA üçün ədəd, Var, Az var, 0).",
  ...
  en: {
    ...
    importSubtitle: "Only .xlsx and .xls. Existing SKU will update product.",
    importColumns: "Columns: MƏHSULUN ADI, BREND KODU, OEM KODU, BAKİ/GANCA, QİYMƏT AZN (BAKİ/GANCA supports number, Var, Az var, 0).",
  ...
  ru: {
    ...
    searchPlaceholder: "Поиск по названию / slug / sku",
    pagination: {
      prev: "Назад",
      next: "Вперед",
      page: "Страница",
    ...
    importSubtitle: "Поддержка .xlsx и .xls. При существующем SKU товар обновляется.",
    importColumns: "Колонки: MƏHSULUN ADI, BREND KODU, OEM KODU, BAKİ/GANCA, QİYMƏT AZN (в BAKİ/GANCA: число, Var, Az var, 0).",
...
export default function AdminPage({language, displayCurrency, currencyRates}: AdminPageProps) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      return [product.name, product.slug, product.sku, product.category]
        .join(" ")
        .toLowerCase()
                        ...
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="theme-text mt-1 text-sm">
                              {product.category} · {product.oemNumber || "OEM"} · {formatConvertedPrice(product.price, displayCurrency, currencyRates, language)} · {product.stockQuantity} {copy.unitShort} · {copy.stockStateOptions[product.stockState]} · {product.brand || "OEM"}
                            </p>
                          </div>
                        </div>
              ...
              <div className="mb-4 flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="theme-muted mt-1 text-xs">
                    SKU: {editForm.sku} · {editForm.category}
                  </p>
                </div>
                <button
                  type="button"
